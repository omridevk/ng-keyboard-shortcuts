...
|  └── app/
|     ├── app.component.ts
|     └── app.keyboard-shortcuts.module.ts
└── lib/
   ├── index.ts
   └── src/
      ├── component/
...
<table width="100%">
  ...
  <tr>
    <td>
      <code>demo/app/app.keyboard-shortcuts.module.ts</code>
    </td>
    <td>
  ...
  <tr>
    <td>
      <code>lib/src/service/keyboard-shortcuts.service.ts</code>
    </td>
    <td>
  ...
  <tr>
    <td>
      <code>lib/src/keyboard-shortcuts.module.ts</code>
    </td>
    <td>
...
- `integration/src/app/app.keyboard-shortcuts.module.ts`
- `integration/src/systemjs.config.js`
- `integrations/package.json`
- `src/demo/app/app.component.ts`
- `src/demo/app/app.keyboard-shortcuts.module.ts`
